      ...
      <>
        {error ? (
            ...
            <Row>
              <Col>
                <p className="px-5">
                  ...
                  {currentAssignment ?? "?"} in your Downloads folder. Please
                  check the <Link to="/activity-log">Activity Log</Link> for
                  more details.
                </p>
          ...
          <Row>
            <Col>
              <h1 className="pb-4">
                Saving Assignment {currentAssignment ?? "Loading..."}
              </h1>
            </Col>
          </Row>
        ) : (
          <>
            <Row>
              <Col>
                <h1 className="pb-4">
                  Assignment {currentAssignment ?? "Loading..."} Saved
                </h1>
              </Col>
            </Row>
            <Row>
