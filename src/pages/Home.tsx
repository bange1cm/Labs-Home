  ...
  return (
    <Container>
      <Row>
        <Col className="py-4">
          <h1>
            Current Assignment: Assignment {currentAssignment ?? "Loading..."}
          </h1>
          <h3>
            <LinkButton onClick={() => navigate("/launch")}>Launch</LinkButton>{" "}
            Assignment
          </h3>
          <h3>
      ...
      <Row>
        <Col className="py-4">
          ...
          <h3>
            <LinkButton onClick={() => navigate("/upload")}>Upload</LinkButton>{" "}
            Professor's Starting File
          </h3>
        </Col>
      </Row>
    </Container>
